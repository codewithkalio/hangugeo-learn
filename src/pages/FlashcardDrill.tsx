    ...
    return (
      <div className="space-y-6 max-w-md mx-auto">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-display font-bold flex items-center gap-2"><Zap className="h-5 w-5 text-[#F0B429]" /> Drill Setup</h1>
        </div>
        ...
        <div className="soft-card p-5 space-y-5">
          ...
          >
            <span className="flex items-center justify-center gap-2">Start Drill <Zap className="h-4 w-4 text-[#F0B429]" /></span>
          </motion.button>
        </div>
      </div>
    );
        ...
        <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="text-center space-y-4">
          ...
          <div className="flex flex-col gap-2">
            {showBoost && (
              ...
              >
                <Sparkles className="h-4 w-4 text-[#F0B429]" /> Boost Weak Words
              </button>
            )}
